...
const DocumentManagement = () => {
  ...
  const departments = [
    {
      ...
      compliant: 98,
      forms: [
        { name: "Fresh Concrete Test - Precast", route: "/templates/fresh-concrete-test", icon: FlaskConical },
        { name: "Fresh Concrete Test - Wall Panels", route: "/templates/wall-panels-fresh-concrete-test", icon: FlaskConical },
        { name: "Fresh Concrete Test - Extruded", route: "/templates/extruded-fresh-concrete-test", icon: FlaskConical },
        { name: "Fresh Concrete Test - Flexicore", route: "/templates/flexicore-fresh-concrete-test", icon: FlaskConical },
        { name: "Fresh Concrete Test - Double Tees", route: "/templates/double-tees-fresh-concrete-test", icon: FlaskConical },
  ...
  const documents = [
    {
      id: "FORM-001",
      name: "Fresh Concrete Test Form - Precast",
      type: "Quality Form",
    ...
    {
      id: "FORM-002",
      name: "Fresh Concrete Test Form - Wall Panels",
      type: "Quality Form",
      department: "Quality Control",
      version: "Rev 1.0",
      isoCompliant: true,
      ...
      nextReview: "2024-07-15",
      isForm: true,
      route: "/templates/wall-panels-fresh-concrete-test"
    },
    {
      id: "FORM-003",
      name: "Fresh Concrete Test Form - Extruded",
      type: "Quality Form",
      department: "Quality Control",
      version: "Rev 1.0",
      isoCompliant: true,
      ...
      nextReview: "2024-07-15",
      isForm: true,
      route: "/templates/extruded-fresh-concrete-test"
    },
    {
      id: "FORM-004",
      name: "Fresh Concrete Test Form - Flexicore",
      type: "Quality Form",
      department: "Quality Control",
      version: "Rev 1.0",
      isoCompliant: true,
      ...
      nextReview: "2024-07-15",
      isForm: true,
      route: "/templates/flexicore-fresh-concrete-test"
    },
    {
      id: "FORM-005",
      name: "Fresh Concrete Test Form - Double Tees",
      type: "Quality Form",
      department: "Quality Control",
      version: "Rev 1.0",
      isoCompliant: true,
      ...
      nextReview: "2024-07-15",
      isForm: true,
      route: "/templates/double-tees-fresh-concrete-test"
    },
    {
      id: "FORM-006",
