        ...
        <Table>
          <TableHeader>
            ...
            <TableRow>
              ...
              <TableHead className="w-17 text-xs leading-tight p-1">Release/<br/>Required</TableHead>
              ...
              <TableHead className="w-17 text-xs leading-tight p-1">Average/<br/>Required</TableHead>
