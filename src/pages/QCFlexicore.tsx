  ...
  const qcSections = [
    {
      ...
      icon: Calendar,
      color: "orange",
      onClick: () => navigate('/qc/flexicore/workspace')
    },
    {
      ...
      icon: TestTube,
      color: "blue",
      onClick: () => navigate('/qc/flexicore/fresh-concrete')
    },
    {
      ...
      icon: Database,
      color: "purple",
      onClick: () => navigate('/qc/flexicore/aggregate')
    },
    {
      title: "Resources",
      ...
      icon: BookOpen,
      color: "green",
      onClick: () => navigate('/qc/flexicore/resources')
    },
    {
      title: "Calibrations",
      ...
      icon: Settings,
      color: "red",
      onClick: () => navigate('/qc/flexicore/calibrations')
    },
    {
      title: "Mix Designs",
      ...
      icon: Beaker,
      color: "indigo",
      onClick: () => navigate('/qc/flexicore/mix-designs')
    }
  ];
        ...
        <div className="container mx-auto">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold">Flexicore QC</h1>
                <p className="text-blue-100 mt-1">Quality Control Operations - Flexicore Department</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto p-6">
        <div className="space-y-6">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Select a section to access Flexicore QC operations</p>
          </div>
