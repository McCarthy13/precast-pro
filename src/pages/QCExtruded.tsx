  ...
  const qcSections = [
    {
      ...
      icon: Calendar,
      color: "purple",
      onClick: () => navigate('/qc/extruded/workspace')
    },
    {
      ...
      icon: TestTube,
      color: "blue",
      onClick: () => navigate('/qc/extruded/fresh-concrete')
    },
    {
      ...
      icon: Database,
      color: "green",
      onClick: () => navigate('/qc/extruded/aggregate')
    },
    {
      title: "Resources",
      ...
      icon: BookOpen,
      color: "orange",
      onClick: () => navigate('/qc/extruded/resources')
    },
    {
      title: "Calibrations",
      ...
      icon: Settings,
      color: "red",
      onClick: () => navigate('/qc/extruded/calibrations')
    },
    {
      title: "Mix Designs",
      ...
      icon: Beaker,
      color: "indigo",
      onClick: () => navigate('/qc/extruded/mix-designs')
    }
  ];
        ...
        <div className="container mx-auto">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold">Extruded QC</h1>
                <p className="text-blue-100 mt-1">Quality Control Operations - Extruded Department</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto p-6">
        <div className="space-y-6">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Select a section to access Extruded QC operations</p>
          </div>
